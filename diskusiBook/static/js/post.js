...
async function refreshComments() {
    ...
    const editDeleteButtonsPost = `
        <button class="btn btn-outline-primary" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal${singlePost.pk}">Edit</button>
                <button class="btn btn-outline-danger" type="button" onclick="deletePost(${singlePost.pk}); return false;">Delete</button>
        `;
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="Commentform${singlePost.pk}" onsubmit="return false;">
                    <div class="mb-3">
                        <label for="Commentcontent" class="col-form-label">Content</label>
...
<button class="btn btn-outline-secondary" type="button" data-bs-toggle="modal" data-bs-target="#CommentModal${singlePost.pk}">Comment</button>
    ...
    for (let comment of comments) {
        ...
        <button class="btn btn-outline-primary" type="button" data-bs-toggle="modal" data-bs-target="#CommentEditModal${comment.pk}">Edit</button>
                <button class="btn btn-outline-danger" type="button" onclick="deleteComment(${comment.pk}); return false;">Delete</button>
        `;
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="CommentEditform${comment.pk}" onsubmit="return false;">
                    <div class="mb-3">
                        <label for="CommentEditcontent" class="col-form-label">Content</label>
                        <textarea class="form-control" id="CommentEditcontent" name="CommentEditcontent"></textarea>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="Replyform${comment.pk}" onsubmit="return false;">
                                        <div class="mb-3">
                                            <label for="Replycontent" class="col-form-label">Content</label>
            ...
            <button class="btn btn-outline-primary" type="button" data-bs-toggle="modal" data-bs-target="#ReplyEditModal${reply.pk}">Edit</button>
                    <button class="btn btn-outline-danger" type="button" onclick="deleteReply(${reply.pk}); return false;">Delete</button>
            `;
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="ReplyEditform${reply.pk}" onsubmit="return false;">
                        <div class="mb-3">
                            <label for="ReplyEditcontent" class="col-form-label">Content</label>
                            <textarea class="form-control" id="ReplyEditcontent" name="ReplyEditcontent"></textarea>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
